...
function setupScan() {
  ...
  byId('scan-export').addEventListener('click', async () => {
    const result = await api.exportReport(lastScan, 'bcrypt-guard-assessment.json');
...
function setupBenchmark() {
  ...
  byId('bcrypt-export').addEventListener('click', async () => {
    const result = await api.exportReport(lastBenchmark, 'bcrypt-guard-benchmark.json');
